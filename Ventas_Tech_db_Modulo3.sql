CREATE DATABASE Ventas_Tech_db_Modulo3;
 
USE Ventas_Tech_db_Modulo3; 
...
(3, 'Auriculares WH-CH520', 'Sony', 80000.00, 60000.00, 2), 
(4, 'Parlante portatil', 'JBL', 120000.00, 90000.00, 2),
(5, 'Sony ZV-1F', 'Sony', 1200000.00, 900000.00, 3),
(6, 'EOS R50', 'Canon', 1000000.00, 850000.00, 3);
...
(3, 'Clara Rodriguez', 'clara_rodriguez@gmail.com', 'La Plata', 'Minorista', '2026-09-04', 3);
